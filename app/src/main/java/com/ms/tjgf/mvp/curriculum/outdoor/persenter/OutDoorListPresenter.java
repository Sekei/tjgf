package com.ms.tjgf.mvp.curriculum.outdoor.persenter;
 ...
 * MissSekei 2018-1-22
 */
public class OutDoorListPresenter extends BasePresenter<IOutDoorView, RespBean<OutDoorBean>> implements IBaseListPresenter {
    private int page = 0;
    private boolean isRefresh;
    private OutDoorListInteractor iOutDoorListInteractor;
    private List<OutDoorData> newsList = new ArrayList<>();

    public OutDoorListPresenter(IOutDoorView mView) {
        super(mView);
        iOutDoorListInteractor = new OutDoorListInteractor();
    }
    ...
    public void requestNewsList(boolean isRefresh) {
        ...
        iOutDoorListInteractor.requestOutDoorList(new HttpApiOutDoor(page), "outdoor", this);
    }

    @Override
    public void onSuccess(RespBean<OutDoorBean> data, String reqTag) {
